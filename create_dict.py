...
nalpha_fac = np.floor(
    np.floor((nprocspernode * nodesperball) / totalnexecball) * 1 / nsurfs
)
...
save_dict = {
    "maxf": maxf,
    "eqbm_option": eqbm_option,
    "pol_idxs": pol_idxs,
    "tor_idxs": tor_idxs,
    "iotaidxs": iotaidxs,
    "isphifree": isphifree,
    "totalndofs": totalndofs,
    "nsurfs": nsurfs,
    "abs_step": abs_step,
    "rel_step": rel_step,
    "username": username,
    "nprocspernode": nprocspernode,
    "nodesperball": nodesperball,
    "totalnexecball": totalnexecball,
    "njobsball": njobsball,
    "nodespersimsopt": nodespersimsopt,
}
